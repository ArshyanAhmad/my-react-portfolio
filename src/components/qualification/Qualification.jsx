                    ...
                    <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"} >
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className='qualification__subtitle'>BIT - Institute</span>
                    ...
                    <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"} >
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className='qualification__subtitle'>Microsoft - Bengaluru</span>
                                <div className="qualification__calender">
                                    <i className='uil uil-calender-alt'></i>2022 - present
                                </div>
                            </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className='qualification__subtitle'>Apple Inc - India</span>
                                <div className="qualification__calender">
                                    <i className='uil uil-calender-alt'></i>2020 - 2021
                                </div>
                            </div>
